...
class ApplicationSetting extends Model
{
    ...
    {
        return max(0, min(1000, (float) static::getValue('low_stock_warning_percentage', 10)));
    }
    ...
    {
        $stored = static::query()->whereIn('key', array_keys(self::DEFAULT_BUTTON_THEME))->pluck('value', 'key');
        $theme = [];
