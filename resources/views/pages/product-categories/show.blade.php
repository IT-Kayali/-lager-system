<x-layouts.premium title="Kategorievorschau" subtitle="Eigenschaften der Kategorie und alle enthaltenen Produkte.">
    ...
    <section class="category-preview-actions">
        <a class="premium-btn gold" href="{{ route('product-categories.edit', $category) }}">
            <i class="bi bi-pencil"></i>
            Bearbeiten
        </a>

        <a class="premium-btn" href="{{ route('product-categories.index') }}">
    ...
    <section class="preview-grid">
        <div class="premium-card">
            ...
            <div class="details-grid">
                ...
                <div>
                    <span>Farbe</span>
                    <strong class="color-value">
                        <i style="background: {{ $category->color ?: '#d4af37' }};"></i>
                        {{ $category->color ?: '#d4af37' }}
                    </strong>
                </div>

                <div>
                    <span>Erstellt</span>
                    <strong>{{ $category->created_at ? $category->created_at->format('d.m.Y H:i') : '—' }}</strong>
                </div>

                <div>
                    <span>Aktualisiert</span>
                    <strong>{{ $category->updated_at ? $category->updated_at->format('d.m.Y H:i') : '—' }}</strong>
                </div>
            </div>
        </div>
        ...
        <div class="section-head">
            <div>
                ...
                <p class="premium-muted" style="margin:4px 0 0;">
                    Alle Produkte, die dieser Kategorie zugeordnet sind.
                </p>
            </div>
            ...
            <table class="category-products-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7">
                                <div class="premium-muted">Diese Kategorie enthält noch keine Produkte.</div>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <style>
        ...
        .category-products-table tr:hover td {
            background: #fffaf0;
        }
